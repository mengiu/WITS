...
import org.front.end.wits.vaadin.ui.AbstractPage;
import org.front.end.wits.vaadin.ui.view.workflow.process.AbstractProcessDefinitionDetailPanel;
  ...
  protected void initActions(final AbstractPage parentPage) {
    ...
    suspendButton.addListener(new ClickListener() {
      ...
      public void buttonClick(ClickEvent event) {
        ...
        WitsApp.get().getViewManager().showPopupWindow(popupWindow);
      }
