...
public class Constants {
	...
	public static final String SEPARATOR_ROLES = "_";
	...
	// MIMETYPES
	public static final String MIMETYPE_BPM = "image/bmp";
	public static final String MIMETYPE_GIF = "image/gif";
	public static final String MIMETYPE_JPEG = "image/jpeg";
	public static final String MIMETYPE_PNG = "image/png";
	public static final String MIMETYPE_PJPEG = "image/pjpeg";  /* only for Internet Explorer
 most browsers wouldn't mind, except Internet Explorer which treats pjpeg files differently from jpeg */

	public static final Collection<String> DEFAULT_IMAGE_MIMETYPES = Arrays.asList(
			MIMETYPE_BPM, MIMETYPE_GIF, MIMETYPE_JPEG, MIMETYPE_PJPEG , MIMETYPE_PNG);

	public static Map<String, String> MIMETYPE_EXTENSION_MAPPING;
	static {
		Map<String, String> mapping = new HashMap<String, String>();   
		mapping.put(MIMETYPE_BPM, "bmp");
