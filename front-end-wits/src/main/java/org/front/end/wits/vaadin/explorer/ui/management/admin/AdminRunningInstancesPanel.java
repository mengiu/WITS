...
import org.front.end.wits.vaadin.ui.custom.UserProfileLink;
import org.front.end.wits.vaadin.ui.mainlayout.ExplorerLayout;
import org.front.end.wits.vaadin.ui.view.workflow.process.ProcessDefinitionImageStreamResourceBuilder;
import org.front.end.wits.vaadin.ui.variable.VariableRendererManager;
...
public class AdminRunningInstancesPanel extends DetailPanel {
  ...
  public AdminRunningInstancesPanel() {
    ...
    this.variableRendererManager = WitsApp.get().getVariableRendererManager();
