...
import org.front.end.wits.vaadin.data.AbstractLazyLoadingQuery;
  ...
  public static class DeploymentListitem extends PropertysetItem implements Comparable<DeploymentListitem> {
    ...
    public DeploymentListitem(Deployment deployment) {
      ...
      if(deployment.getName() != null) {
        ...
        addItemProperty("name", new ObjectProperty<String>(WitsApp.get().getI18nManager().getMessage(Messages.DEPLOYMENT_NO_NAME), String.class));
      }
    }
