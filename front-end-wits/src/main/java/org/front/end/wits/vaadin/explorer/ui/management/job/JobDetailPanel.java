 ...
 */
package org.front.end.wits.vaadin.explorer.ui.management.job;
...
import org.front.end.wits.vaadin.NotificationManager;
import org.front.end.wits.vaadin.ui.Images;
import org.front.end.wits.vaadin.ui.custom.DetailPanel;
import org.front.end.wits.vaadin.ui.custom.PrettyTimeLabel;
...
public class JobDetailPanel extends DetailPanel {
  ...
  public JobDetailPanel(String jobId, JobPage jobPage) {
    ...
    this.notificationManager = WitsApp.get().getNotificationManager();
  ...
  protected void addActions() {
    ...
    deleteButton.addListener(new ClickListener() {
      ...
      public void buttonClick(ClickEvent event) {
        ...
        jobPage.refreshSelectNextFirstTable();
      }
    });
    ...
    showProcessDefinitionLink.addListener(new ClickListener() {
      ...
      public void buttonClick(ClickEvent event) {
        if (isSuspendedProcessDefinition) {
          WitsApp.get().getViewManager().showSuspendedProcessDefinitionsPage(job.getProcessDefinitionId());
        } else {
          WitsApp.get().getViewManager().showActiveProcessDefinitionsPage(job.getProcessDefinitionId());
        }
      }
    });
