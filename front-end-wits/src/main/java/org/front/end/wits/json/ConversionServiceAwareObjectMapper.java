package org.front.end.wits.json;
...
public class ConversionServiceAwareObjectMapper extends ObjectMapper {
	...
	public ConversionServiceAwareObjectMapper(ConversionService conversionService) {
		...
		SerializationConfig sconfig = new SerializationConfig(DEFAULT_INTROSPECTOR, introspector,  VisibilityChecker.Std.defaultInstance(), null ); //_subtypeResolver , null ,  _typeFactory , null);
    	DeserializationConfig dconfig = new DeserializationConfig(DEFAULT_INTROSPECTOR, introspector,  VisibilityChecker.Std.defaultInstance(), null ); //_subtypeResolver , null ,  _typeFactory , null );
