        ...
        try {
          ...
          if (bpmnModel.getMainProcess() == null || bpmnModel.getMainProcess().getId() == null) {
            ...
            if (bpmnModel.getLocationMap().size() == 0) {
              ...
              close();
              WitsApp.get().getViewManager().showEditorProcessDefinitionPage(modelData.getId());
              WitsApp.get().getMainWindow().open(new ExternalResource(
                  WitsApp.get().getURL().toString() + "service/editor?id=" + modelData.getId()));
            }
          }
